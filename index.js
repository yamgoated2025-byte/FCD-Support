    ...
    if (type === 'league') {
      ...
      if (action === 'join') {
        ...
        return interaction.editReply({
          content: `You have joined league \`${id}\`. You have been added to the private league thread.`,
        });
      }
    ...
    if (type === 'event') {
      ...
      if (action === 'cancel') {
        ...
        await interaction.message.edit({
          content:    `Event \`${id}\` has been cancelled.`,
          embeds:     [],
          components: [],
        }).catch(() => {});
  ...
  if (commandName === 'league') {
    ...
    try {
      ...
      const threadEmbed = new EmbedBuilder()
        ...
        .addFields(
          { name: 'Join Method',   value: `Click the "Join League" button in the main channel`,   inline: false },
          { name: 'Cancel Method', value: `Click the "Cancel League" button in the main channel`, inline: false },
        )
        .setTimestamp();
